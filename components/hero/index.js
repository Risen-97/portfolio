      ...
      <div className=" h-full flex flex-col lg:flex-row  lg:justify-between justify-center items-center">
        <div className="text-center lg:text-left">
          ...
          <p className="text-gray-500 dark:text-gray-300 leading-8 font-medium lg:max-w-lg mb-10">
            Creative Junior Front-end Developer with almost 2+ years of
            experience, building and maintaining responsive websites in the
            recruiting industry. Proficient in HTML, CSS, JavaScript, and
            Specialize in React framework
          </p>

          <a href="/Mohamed_Fareed_CV.pdf" download className="btn">
            Download my resume
          </a>
        </div>
